...
<body>
 ...
 <h1 style=" color:rgb(36, 29, 80);font-size:20pt;text-align: center;padding-top: 60px;">:[مطعم دار حمد ]</h1>
...
if(!isset($_SESSION['user'])){
 ...
 <div  class="d-flex flex-column bd-highlight mb-3 container">
  ...
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3478.0593051117658!2d48.06225228490136!3d29.3392576821443!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3fcf9da273d6c16b%3A0x3c3f50508a3b575!2z2K_Yp9ixINit2YXYrw!5e0!3m2!1sar!2skw!4v1595192071700!5m2!1sar!2skw" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
<div  class="d-flex flex-column bd-highlight mb-3 container">
<p class="p-2 bd-highlight" style=" color:rgb(36, 29, 80);font-size:20pt;text-align: right;">:اطلالات وصور المطعم </p>
  ...
  <div class="swiper-container">
    ...
    <div class="swiper-slide" ><img src="./img/download (2).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/download (3).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/download (4).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/images (4).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/dar-hamad.jpg" style="width: 300px;height: 300px;"></div>
</div>
