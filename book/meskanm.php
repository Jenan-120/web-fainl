...
<body>
  ...
  <header>
    ...
    <ul>
      ...
      <li><a href="home.php"  style="font-size: 20px;"> الحساب </a></li>
      <li><a href="contactus.php" style="font-size: 20px;">تواصل معنا </a></li>
      <li><a href="aboutus.php" style="font-size: 20px;">عنا </a></li>
    </ul>
  </header>

 <h1 style=" color:rgb(36, 29, 80);font-size:20pt;text-align: center;padding-top: 60px;">:[ مطعم ميس الغانم ]</h1>

 <?php
if(!isset($_SESSION['user'])){
   ?>
  <div style= 'float:center;text-align:center' ><a href="formmes.php"><h2 style="color:white;font-size:30pt;">احجز الآن</h2></a></div>
      <?php  } ?>
 ...
 <div  class="d-flex flex-column bd-highlight mb-3 container">
  ...
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d111241.7782508055!2d48.06834794179686!3d29.3906158!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3fcf8483024949ab%3A0xc7f12466f4ae01c9!2z2YXYt9i52YUg2YXZitizINin2YTYutin2YbZhQ!5e0!3m2!1sar!2skw!4v1595169921801!5m2!1sar!2skw" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d111307.48758846696!2d48.00739884179685!3d29.330473300000012!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3fcf9ab6c8b7346f%3A0xe708cf78ac1913e7!2sMais%20Alghanim%20To%20Go%2C%20Shuwaikh!5e0!3m2!1sar!2skw!4v1595169965271!5m2!1sar!2skw" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
...
<p class="p-2 bd-highlight" style=" color:rgb(36, 29, 80);font-size:20pt;text-align: right;">:اطلالات وصور المطعم </p>
  ...
  <div class="swiper-container">
    ...
    <div class="swiper-slide" ><img src="./img/images (1).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/images (2).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/images (3).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/images (4).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/images (5).jpg" style="width: 300px;height: 300px;"></div>
