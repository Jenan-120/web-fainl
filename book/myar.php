...
<body>
 ...
 <h1 style=" color:rgb(36, 29, 80);font-size:20pt;text-align: center;padding-top: 60px;">:[مطعم ميار اللبناني]</h1>
...
if(!isset($_SESSION['user'])){
 ...
 <div  class="d-flex flex-column bd-highlight mb-3 container">
  ...
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3476.768516015205!2d47.978911584900565!3d29.377066382130014!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3fcf84ec29edfe2d%3A0x60ddbd419d97809e!2z2YXYt9i52YUg2YXZitin2LEg2YTZhNmF2KPZg9mI2YTYp9iqINin2YTZhNio2YbYp9mG2YrYqQ!5e0!3m2!1sar!2skw!4v1595182317943!5m2!1sar!2skw" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
...
<p class="p-2 bd-highlight" style=" color:rgb(36, 29, 80);font-size:20pt;text-align: right;">:اطلالات وصور المطعم </p>
  ...
  <div class="swiper-container">
    ...
    <div class="swiper-slide" ><img src="./img/images (11).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/cc.jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/images (10).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/images (9).jpg" style="width: 300px;height: 300px;"></div>
    <div class="swiper-slide" ><img src="./img/images (8).jpg" style="width: 300px;height: 300px;"></div>
  </div>
